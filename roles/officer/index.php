...
<main id="content" class="p-6 bg-gradient-to-br from-slate-50 to-slate-100 min-h-[calc(100vh-var(--header-h))]">
  <div class="max-w-7xl mx-auto space-y-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <a href="incident.php" class="group block rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-red-300">
        <div class="flex items-center mb-4">
          <div class="flex-shrink-0">
        ...
        <p class="text-slate-600 mb-4">Report and manage security incidents.</p>
      ...
      <a href="transfers.php" class="group block rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-yellow-300">
        <div class="flex items-center mb-4">
          <div class="flex-shrink-0">
          ...
          <h2 class="ml-4 text-xl font-semibold text-slate-800 group-hover:text-yellow-600">Transfers</h2>
        </div>
        <p class="text-slate-600 mb-4">Handle inmate transfers and releases.</p>
      ...
      <a href="visitation.php" class="group block rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-purple-300">
        <div class="flex items-center mb-4">
          <div class="flex-shrink-0">
          ...
          <h2 class="ml-4 text-xl font-semibold text-slate-800 group-hover:text-purple-600">Visitations</h2>
        </div>
        <p class="text-slate-600 mb-4">Manage visitation schedules and approvals.</p>
      ...
      <a href="Reports.php" class="group block rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-indigo-300">
        <div class="flex items-center mb-4">
          <div class="flex-shrink-0">
          ...
          <h2 class="ml-4 text-xl font-semibold text-slate-800 group-hover:text-indigo-600">Reports</h2>
        </div>
        <p class="text-slate-600 mb-4">Generate and view operational reports.</p>
        <span class="inline-flex items-center text-sm font-medium text-indigo-700 group-hover:text-indigo-800 group-hover:underline">
          Go to Reports
          <svg class="ml-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
          </svg>
