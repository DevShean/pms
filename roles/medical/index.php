...
$total_records = $conn->query("SELECT COUNT(*) AS total FROM medical_records")->fetch_assoc()['total'];
$total_incidents = $conn->query("SELECT COUNT(*) AS total FROM incidents")->fetch_assoc()['total'];
$pending_health_checks = $conn->query("SELECT COUNT(*) AS total FROM medical_records WHERE next_checkup_date <= CURDATE() AND next_checkup_date != ''")->fetch_assoc()['total'];
  ...
  <div class="max-w-7xl mx-auto space-y-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-3xl font-bold text-slate-900">Medical Dashboard</h1>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            <p class="text-sm font-medium text-slate-500">Medical Records</p>
            <p class="text-2xl font-bold text-slate-900"><?= (int)$total_records ?></p>
          </div>
        </div>
      </div>
      <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
      ...
      <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            <p class="text-sm font-medium text-slate-500">Pending Checkups</p>
            <p class="text-2xl font-bold text-slate-900"><?= (int)$pending_health_checks ?></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      <a href="inmates.php" class="group block rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-blue-300">
        <div class="flex items-center mb-4">
          ...
          <h2 class="ml-4 text-xl font-semibold text-slate-800 group-hover:text-blue-600">View Inmates</h2>
        </div>
        <p class="text-slate-600 mb-4">Access inmate profiles and medical history.</p>
      ...
      <a href="medical.php" class="group block rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-green-300">
        <div class="flex items-center mb-4">
          <div class="flex-shrink-0">
          ...
          <h2 class="ml-4 text-xl font-semibold text-slate-800 group-hover:text-green-600">Medical Records</h2>
        </div>
        <p class="text-slate-600 mb-4">Manage and view all medical records.</p>
      ...
      <a href="incidents.php" class="group block rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-red-300">
        <div class="flex items-center mb-4">
          <div class="flex-shrink-0">
          ...
          <h2 class="ml-4 text-xl font-semibold text-slate-800 group-hover:text-red-600">Incidents</h2>
        </div>
        <p class="text-slate-600 mb-4">View and manage health-related incidents.</p>
      ...
      <a href="health_reports.php" class="group block rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-purple-300">
        <div class="flex items-center mb-4">
          <div class="flex-shrink-0">
          ...
          <h2 class="ml-4 text-xl font-semibold text-slate-800 group-hover:text-purple-600">Health Reports</h2>
        </div>
        <p class="text-slate-600 mb-4">Generate and view health reports.</p>
